...
|---|---|---|---|
| Compendio | `claude.ai/code/artifact/8845e548-f4b3-4f9d-9aa1-b78961b55c33` | `docs/web/compendio.html` (aquí) | **vigente · corte 2026-08-29 noche (2.ª tanda)** — reescrito entero para la era WorldGen3 (ADR-095 a 109), con la mudanza de autoridad cerrada y las **torres** de VERTICALITY-ROADMAP D1 (3 a 6 plantas por región, 1140 tests, HEAD `1d901d31`). Ya no comprime sólo a los otros cuatro: su fuente principal es el repo (`STATE.md`, `WG3-ROADMAP.md`, `DECISIONS.md`, `AUDIT-2026-08-28.md`) |
| Análisis de loop | `claude.ai/code/artifact/27c4bfe4-3a84-4fe5-8e50-8371e99a6d68` | **`docs/web/dossier-loop.html` (aquí, recuperado del artifact vivo el 2026-08-29)** | **vigente · rev. 37** — rev. 36 más el tramo de **torres y aterrizaje por unión**: ninguna región baja de 3 plantas, entrada de devlog propia, dos reglas medidas nuevas y la corrección de que un muro construido ya se rodea. Pestaña «Mundo — WG3» con la mudanza CERRADA y la retirada por etapas (ADR-109); calendario resuelto en favor del repo; pestaña Semana archivada |
