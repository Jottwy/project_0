...
use crate::world::generator::{
    ...
    structure_bounds, structure_id, t_junction_rotation, TEMPLATE_ARCH_ROOM,
    TEMPLATE_BLACKOUT_ZONE, TEMPLATE_CLEANING_AREA, TEMPLATE_DANGER_ROOM, TEMPLATE_DEAD_END,
    ...
    TEMPLATE_PIT_ROOM_PLACEHOLDER, TEMPLATE_POI_ANOMALY, TEMPLATE_POI_DANGER_POCKET,
    TEMPLATE_POI_LANDMARK, TEMPLATE_POI_SAFE_POCKET, TEMPLATE_RED_ROOM_WARNING,
