...
namespace BackroomsSurvival.Gameplay.GridWorld
{
    ...
    public static class WorldGenerator
    {
            ...
            LayerConfig cfg, HashSet<int> forcedWalkable = null)
        {
            ...
            // Step 4 — pits near walls (disabled: Pits to be reintroduced
            // with a better system; PlacePits kept for that future use).
        ...
        private static LayerConfig DefaultConfig(int layer)
        {
            ...
            switch (layer)
            {
                case 0:
                    ...
                    cfg.openZoneSize=4;    cfg.pitChance=0.00f; cfg.pillarChance=0.30f;
                ...
                case 1:
                    ...
                    cfg.openZoneSize=3;    cfg.pitChance=0.00f; cfg.pillarChance=0.15f;
                ...
                case 2:
                    ...
                    cfg.openZoneSize=2;    cfg.pitChance=0.00f; cfg.pillarChance=0.10f;
                ...
                default:
                    ...
                    cfg.openZoneSize=2;    cfg.pitChance=0.00f; cfg.pillarChance=0.05f;
