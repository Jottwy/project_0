...
namespace BackroomsSurvival.Migration.STPIntegration
{
    ...
    ///
    /// WHAT THIS HOOK DOES NOT DO: it does not pose the arm. The planks hang off a hand driven by the
    /// ordinary locomotion blend tree, so a walking peer swings them. Fixing that is a separate
    /// slice, deliberately: there is no third-person carry clip anywhere in the project, and the
    /// vendor's carry AnimatorOverrideController belongs to the first-person viewmodel.
    ///
    ...
    public sealed class ProxyCarryHook : MonoBehaviour
    {
        ...
        // Placement AFTER the Animator, same ordering as the other bone hooks, and re-applied every
        // frame so editing the CarryPoseSet calibrates live during Play.
