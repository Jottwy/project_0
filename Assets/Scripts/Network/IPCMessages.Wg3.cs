...
namespace BackroomsSurvival.Net
{
    ...
    public class Wg3PropMsg
    {
        ...
        /// <summary>ADR-129 enm. 2 — variantes de sala de servicio/almacén, sin nombre hasta
        /// ahora (`Wg3PropCatalog.NameOf` los resolvía por literal). ADR-145 D1 los necesita
        /// nombrados para el gating de kinds físicos.</summary>
        public const byte TableLong = 16, Counter = 17, Microwave = 18, Fridge = 19, Rack = 20;

        /// <summary>ADR-105 enm. 20 — el deterioro del falso techo. Estos DOS no tienen prefab: los
