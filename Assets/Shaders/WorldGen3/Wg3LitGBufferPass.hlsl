...
// WG3 (A4): copia de URP 17.0.4. La humedad y la rejilla estocástica necesitan la posición de mundo
// en el fragmento, y Wg3InitializeLitSurfaceData sustituye a InitializeStandardLitSurfaceData.
...
FragmentOutput LitGBufferPassFragment(Varyings input)
{
    ...
    Wg3InitializeLitSurfaceData(input.uv, input.positionWS, surfaceData);
